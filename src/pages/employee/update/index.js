...
export default function UpdateEmployee() {
    ...
    const [urlImage, setUrlImage] = React.useState(''); //url para imagem visualizada
    const [changedImg, setChangedImg] = React.useState(false);
    const [errorMessage, setErrorMessage] = React.useState('');
    const { id } = useParams();
    const navigate = useNavigate();
    const [levelAccess, setLevelAccess] = React.useState('');
    ...
    const getUserFirestore = async (id) => {
        ...
        if (data.exists) {
            if (user === null) {
               ...
               setLevelAccess(getData.levelAccess);
            }
        }
                ...
                <div className="containerForm">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="containerRow">
                            ...
                            {
                                atualUser && levelAccess === 'minimum' && user.levelAccess === 'medium'
                                    ? <> <div className="itemForm">
